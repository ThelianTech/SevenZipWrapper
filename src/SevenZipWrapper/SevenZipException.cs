...
{
    public ArchiveFailure Failure { get; } = new(FailureKind.Unknown, "7-Zip operation failed.");

    public SevenZipException(ArchiveFailure failure, Exception? innerException = null)
        : base(failure.Message, innerException) => Failure = failure;
    /// <summary>
