...
public static class Formats
{
    ...
    /// <summary>
    /// Maps formats with lightweight offset-zero detection to their leading magic bytes.
    /// Offset-dependent formats require extension fallback or an explicit format.
    /// Empty ZIP end records are recognized separately by the detector.
    /// </summary>
    internal static readonly FrozenDictionary<SevenZipFormat, byte[]> FileSignatures =
        new Dictionary<SevenZipFormat, byte[]>
        {
            ...
            [SevenZipFormat.Zip] = [0x50, 0x4B, 0x03, 0x04],
